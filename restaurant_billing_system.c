...
switch(code){
           case 1:strcpy(newNode->item_name,"Chilli Potato");
                  newNode->amount=quantity*80;
                  break;
           case 2:strcpy(newNode->item_name,"Momos");
                  newNode->amount=quantity*70;
                  break;
           case 3:strcpy(newNode->item_name,"Chicken Roll");
                  newNode->amount=quantity*120;
                  break;
           case 4:strcpy(newNode->item_name,"Chowmein");
                  newNode->amount=quantity*70;
                  break;
           case 5:strcpy(newNode->item_name,"Chicken Chowmein");
                  newNode->amount=quantity*90;
                  break;
           case 6:strcpy(newNode->item_name,"Mutton Keema");
                  newNode->amount=quantity*280;
                  break;
           case 7:strcpy(newNode->item_name,"Veg Fried Rice");
                  newNode->amount=quantity*100;
                  break;
           case 8:strcpy(newNode->item_name,"Chicken Korma");
                  newNode->amount=quantity*250;
                  break;
           case 9:strcpy(newNode->item_name,"Malai Chaap");
                  newNode->amount=quantity*150;
                  break;
           case 10:strcpy(newNode->item_name,"Paneer Tikka");
                  newNode->amount=quantity*150;
                  break;
           default: printf("Item does not exist\n");
}
     // CASE 1: FIRST NODE
       if(head==0){
           head=newNode;
...
void PrintBill()
{
    ...
    printf("  TOKEN   ");
    printf("**************\n\n");
    printf("DATE:%s CASHIER:AKANSHA SINGHAL\n",__DATE__);
      printOrder();
      int price=sum();
    printf("\n      Total bill amount = %d\n", price);
    printf("-------------------------------------");
